...
def GET():
    ...
    S1=userbox.get()
    S2=passbox.get()
    if(S1=='Kathit' and S2=='1234567'):
        menu()
    elif(S1=='Yash' and S2=='1234567'):
        menu()
    elif(S1=='Archi' and S2=='1234567'):
        menu()
    else:
...
def Entry():
    ...
    bottomframe.pack()
    heading = tkinter.Label(topframe, text="Welcome to CHARUSAT Hospital",fg='red',font='Times 16 bold italic')
    ...
    login = tkinter.Button(bottomframe, text="LOGIN", command=lambda:(GET(),root.destroy),font="arial 8 bold")
    heading.pack()
    username.pack()
    userbox.pack()
    password.pack()
    passbox.pack()
    login.pack()
    root.title("Hospital Login Page")
    root.mainloop()
